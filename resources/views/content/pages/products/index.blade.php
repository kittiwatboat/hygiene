            ...
            >
                ...
                <div class="modal-body">
                    <div class="alert alert-info mb-3">
                        ใช้ไฟล์ Template ล่าสุดของระบบ และอย่าเปลี่ยนชื่อ Header
                        <div class="small mt-1">
                            รูปแบบที่รองรับ: ลำดับ, รหัสสินค้า, ชื่อสินค้า, ประเภทสินค้า,
                            ราคา, หน่วย, จำนวนคงเหลือ, LOT การผลิต, สถานะ, หมายเหตุ
                        </div>
                    </div>
                    ...
                    <div class="form-text mt-2">
                        ถ้ารหัสสินค้ามีอยู่แล้ว ระบบจะอัปเดตข้อมูลเดิม แต่จะไม่ลบ/เปลี่ยนรูปสินค้าเดิม
                    </div>
