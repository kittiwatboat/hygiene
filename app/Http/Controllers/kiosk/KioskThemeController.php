    ...
    return $request->validate(
        [
            ...
            */
            ...
            'header_type' => [
    'nullable',
    Rule::in(['none', 'color', 'image', 'video']),
],
...
'remove_header_background_video' => ['nullable', 'boolean'],
'remove_header_logo_main' => ['nullable', 'boolean'],
'remove_header_logo_right_1' => ['nullable', 'boolean'],
'remove_header_logo_right_2' => ['nullable', 'boolean'],
'header_height' => [
    'nullable',
    'integer',
    'min:40',
